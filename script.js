...
body {
  ...
  min-height: 100vh;
  background:
    radial-gradient(circle at top left, rgba(79, 140, 255, 0.16), transparent 34rem),
    linear-gradient(135deg, #090d14 0%, #0d1420 48%, #10151f 100%);
  color: var(--text);
